...
guaranteed by monotonicity (see assumption  \eqref{assump:Monotonicity condition}) (\red{I think we need to add also the growth condition}). For instance, in the case of one-dimensional SDEs
