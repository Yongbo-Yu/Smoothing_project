...
In this section, I include the results of weak error rates for the case without change of measure for both cases without and with Richardson extrapolation (level $1$ and $2$),  for $H \in \{0.43,0.07,0.02\}$ and for $K \in \{1,0.8,1.2\}$ (for $H=0.02$, I changed the other parameters such that $\xi=0.1, \rho=-0.7,\eta=0.4$). The reference solution was computed with $N=500$ time steps (reported in table \ref{table:Reference solution, using MC with $500$ time steps, of Call option price under rBergomi model, for different parameter constellation.}). We note that the weak errors plotted here corresponds to relative errors. We show in table \ref{table:Reference solution, using MC with $500$ time steps, of Call option price under rBergomi model, for different parameter constellation.} the different paramter constellations that we consider to report our results for MC and MISC.
...
From figures (\ref{fig:Weak_rate_H_043_without_rich},\ref{fig:Weak_rate_H_007_without_rich},\ref{fig:Weak_rate_H_007_without_rich_K_08}), we see that for all cases, we get a weak error of order $\Delta t$, with almost the same constant. The upper and lower bounds are $95\%$ confidence interval.
...
From figures (\ref{fig:Weak_rate_H_043_with_rich}, \ref{fig:Weak_rate_H_007_with_rich},\ref{fig:Weak_rate_H_007_with_rich_K08}), we see that for all cases, we get a weak error of order higher than  $\Delta t^2$ (We expect to have order of $\Delta t^2$ in the asymptotic regime). The upper and lower bounds are $95\%$ confidence interval.
\begin{figure}[h!]
	\centering
	\begin{subfigure}{.4\textwidth}
		\centering
...
\red{We note that the below results are preliminary since we observed an over-estimated tolerance for MISC solver. We need to figure out a way to define the adequate procedure to use the right MISC tolerance. However, as for now, we think that these results are very promising and could be even improved if we solve the issue of mixed difference.}
...
\hline
		...
		MC method ($M=10^4$)   & $0.5$  & $0.6$  & $0.6$ & $0.7$  \\	
		\hline
	\end{tabular}
...
\begin{table}[h!]
	...
	\begin{tabular}{l*{6}{c}r}
		...
		MC Statistical error ($M=10^6$)   & $\underset{( 1e-03)}{\mathbf{1.3e-02}}$  & $\underset{(   3.2e-04)}{\mathbf{4.1e-03}}$  & $\underset{(  1.7e-04)}{\mathbf{2.1e-03}}$ & $\underset{(  1.3e-04)}{\mathbf{1.6e-03}}$ \\	
			...
			MC Statistical error ($M=10^4$)  & $\underset{( 5.5e-03)}{\mathbf{6.9e-02}}$  & $\underset{(   1.5e-03)}{\mathbf{1.9e-02}}$  & $\underset{(  1.4e-03)}{\mathbf{1.8e-02}}$ & $\underset{(  1.2e-03)}{\mathbf{1.5e-02}}$ \\	
		\hline
	\end{tabular}
...
\begin{table}[h!]
	...
	MISC ($TOl=10^{-3}$)  & $\mathbf{ 1.0187}$ & $\mathbf{-}$ & $\mathbf{-}$ & $\mathbf{-}$  \\
		...
		%		MISC ($TOl=10^{-2}$)    & $-$ & $-$  & $-$ & $-$  \\	
		\hline
			MC ($M=10^6$) &$\mathbf{0.9724}$  & $\mathbf{0.1096}$  & $\mathbf{0.0559}$  & $\mathbf{0.0208}$ \\	
...
\begin{table}[h!]
	...
	MC Statistical error ($M=10^4$)  &  $\underset{(  1.4e-03)} {\mathbf{1.9e-02}}$  & $\underset{(9.9e-04)} {\mathbf{1.4e-02}}$  & $\underset{(7.8e-04)} {\mathbf{ 1.1e-02}}$ & $\underset{( 6.4e-04)} {\mathbf{9.0e-03}}$	\\
		\hline
	\end{tabular}
	\caption{Bias and Statistical errors of MC ($M=10^6$)  for computing Call option price  for different number of time steps. Case set 1, without Richardson extrapolation. The numbers between parentheses are the corresponding absolute errors.}
...
\begin{tabular}{l*{6}{c}r}
	...
	MC Statistical error ($M=10^6$)  &  $\underset{(2.9e-04)} {\mathbf{1.3e-03}}$  & $\underset{( 5.2e-04)} {\mathbf{2.3e-03}}$  & $\underset{(  1.8e-04)} {\mathbf{ 7.9e-04}}$ & $\underset{(1.6e-04)} {\mathbf{7.0e-04}}$	\\
	...
	\hline
\end{tabular}
\caption{Bias and Statistical errors of MC ($M=10^6$)  for computing Call option price  for different number of time steps. Case set 3, without Richardson extrapolation. The numbers between parentheses are the corresponding absolute errors.}
...
Method \textbackslash  Steps            & $1-2$ & $2-4$ & $4-8$ & $8-16$  \\
\hline
MC Bias   &$\underset{(    0.0531)}{\mathbf{0.2362}}$  & $\underset{( 0.0040)}{\mathbf{0.0179}}$  & $\underset{(  0.0006)}{\mathbf{0.0027}}$  & $\underset{(0.0003 )}{\mathbf{0.0013}}$ \\	

MC Statistical error   & $\underset{( 5.8e-04)}{\mathbf{2.6e-03}}$  &  $\underset{( 5.8e-04)}{\mathbf{2.6e-03}}$ & $\underset{( 2.2e-04)}{\mathbf{1.0e-03}}$ & $\underset{(1.8e-04 )}{\mathbf{ 8.2e-04}}$ \\	
\hline
\end{tabular}
...
\hline
MC &$\mathbf{0.2388}$  & $\mathbf{0.0205}$  & $\mathbf{0.0037}$  & $\mathbf{0.0021}$ \\	
...
\hline
MC method ($M=10^{6}$)   & $    0.0527$ & $0.0034$  & $ 0.0240$ & $  0.0177$ \\		
...
MC Statistical error ($M=10^6$)  &  $\underset{(2.4e-04)} {\mathbf{2.4e-02}}$  & $\underset{(1.8e-04)} {\mathbf{1.8e-02}}$  & $\underset{(9.4e-05)} {\mathbf{9.5e-03}}$ & $\underset{(6.0e-05)} {\mathbf{6.0e-03}}$	\\

\hline
\end{tabular}
\caption{Bias and Statistical errors of MC ($M=10^6$)  for computing Call option price  for different number of time steps. Case set 4, without Richardson extrapolation. The numbers between parentheses are the corresponding absolute errors.}
...
Method \textbackslash  Steps    &$1-2$         & $2-4$ & $4-8$ & $8-16$\\
\hline
MISC ($TOl=5.10^{-1}$)& $0.0262$  & $0.0084$ & $-0.0004$ & $-0.0016$ \\
MISC ($TOl=10^{-1}$)  &$0.0262$  & $0.0084$ & $-0.0004$ & $-0.0016$  \\
MISC ($TOl=5.10^{-2}$)  &$0.0262$  & $0.0084$ & $-0.0004$ & $-0.0016$  \\
MISC ($TOl=10^{-2}$)  & $0.0668$  & $-0.0069$ & $-0.0004$ & $-0.0016$  \\
\hline
...
Method \textbackslash  Steps            & $1-2$ & $2-4$ & $4-8$ & $8-16$  \\
\hline
MC Bias   &$\underset{(0.0634 )}{\mathbf{6.3745}}$  & $\underset{(0.047)}{\mathbf{0.4716}}$  & $\underset{( 0.0033 )}{\mathbf{0.3291}}$  & $\underset{( 0.0018)}{\mathbf{0.1775}}$ \\	

MC Statistical error   & $\underset{(  4.1e-04)}{\mathbf{4.1e-02}}$  & $\underset{(1.7e-04 )}{\mathbf{1.7e-02}}$  & $\underset{(7.8e-05)}{\mathbf{7.8e-03}}$ & $\underset{(5.1e-05 )}{\mathbf{5.1e-03}}$ \\	
\hline
\end{tabular}
...
\hline
MC  ($M=10^6$)   & $\mathbf{6.415}$  & $\mathbf{0.4886}$  & $\mathbf{0.3369
}$ & $\mathbf{ 0.1827
}$  \\		
\hline
\end{tabular}
...
\begin{table}[h!]
	...
	\begin{tabular}{l*{6}{c}r}
		...
		\hline
		MC method ($M=10^{6}$)   & $    0.1269$ & $0.1257$  & $0.1253$ & $0.1249$ \\		
		...
		Method \textbackslash  Steps            & $2$ & $4$ & $8$ & $16$  \\
		\hline
		MC Bias ($M=10^6$)   & 	$ \underset{(    0.0022)}{\mathbf{0.0174}}$  & $\underset{(0.001)}{\mathbf{0.0078}}$  & $\underset{(0.0005)}{\mathbf{0.0042}}$ & $\underset{(0.0001)}{\mathbf{0.0008}}$\\ 
		
		MC Statistical error ($M=10^6$)  &  $\underset{(   7.9e-05)} {\mathbf{6.3e-04}}$  & $\underset{(7.7e-05)} {\mathbf{6.2e-04}}$  & $\underset{(7.6e-05)} {\mathbf{6.1e-04 }}$ & $\underset{(7.5e-05)} {\mathbf{6.0e-04}}$	\\
		...
		MISC ($TOl=10^{-2}$)  &  $\mathbf{0.0262}$ & $\mathbf{0.0166}$& $\mathbf{ 0.0082}$ & $\mathbf{ 0.0016}$  \\
	\hline
		MC  ($M=10^6$)   & $\mathbf{0.0180}$  & $\mathbf{ 0.0084}$  & $\mathbf{0.0048}$ & $\mathbf{ 0.0014}$  \\		
		\hline
		\end{tabular}
		...
		\hline
		MISC ($TOl=5.10^{-1}$)  & $0.1$ & $0.1$ & $0.2$ & $0.4$  \\
		MISC ($TOl=10^{-1}$)  & $0.1$ & $0.1$ & $0.2$ & $0.9$ \\
		MISC ($TOl=5.10^{-2}$)  & $0.1$ & $0.1$ & $0.2$ & $26$  \\
		MISC ($TOl=10^{-2}$)  & $0.1$ & $0.6$ & $9$ & $105$ \\
		MC method ($M=10^6$)   & $88$  & $96$  & $112$ & $156$  \\	
		\hline
		\end{tabular}
		\caption{Comparsion of the computational time of  MC and MISC, used to compute Call option price of rBergomi model for different number of time steps. Case set $5$ parametrs of table \ref{table:Reference solution, using MC with $500$ time steps, of Call option price under rBergomi model, for different parameter constellation.} }
