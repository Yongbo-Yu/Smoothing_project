...
\begin{table}[h!]
	\centering
	\begin{tabular}{l*{6}{c}r}
		Method \textbackslash  Steps            & $2$ & $4$ & $8$ & $16$ & $32$ & $64$  \\
		\hline
		MISC ($TOl=5.10^{-1}$)  & $\red{0.3662}$ & $\red{0.1578}$ & $\red{0.1010}$ & $\red{0.0758}$ & $-$ & $-$ \\
%		MISC ($TOl=10^{-1}$)  & $0.3662$ &  $0.1578$ & $-$ & $-$  \\
%%		MISC ($TOl=5.10^{-2}$)        & $0.3662$ &$-$ &  $-$ &  $-$ \\
%		MISC ($TOl=10^{-2}$)    & $-$ & $-$  & $-$ & $-$  \\	
		MC method ($M=10^{6}$)   & $\underset{( 0.0454)}{\mathbf{0.5727}}$  & $\underset{ (  0.0208)}{\mathbf{0.2629}}$  & $\underset{(   0.0112)}{\mathbf{0.1411}}$ & $\underset{( 0.0058)}{\mathbf{0.0731}}$ & $\underset{(   0.0034)}{\mathbf{0.0431}}$ & $\underset{(   0.0021)}{\mathbf{0.0260}}$ \\	
		\hline
	\end{tabular}
...
%		%				MC method ($M=10^{6}$)    & $0.0840$ & $0.0781$  & $0.0746$ & $0.0729$  \\
	MC method ($M=10^{6}$)   & $\underset{(1.05e-03)}{0.1246} $  & $\underset{(1.86e-04)}{0.1000} $  & $\underset{ (1.35e-04)}{0.0904}$ & $\underset {(1.08e-04)}{ 0.0850} $ \\		
		\hline
	\end{tabular}
