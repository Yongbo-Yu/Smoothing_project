...
\begin{table}[h!]
	...
	\begin{tabular}{l*{6}{c}r}
		...
		MISC ($TOl=10^{-4}$)  & $\underset{( 0.0001)}{\mathbf{    0.0008}}$ & $\underset{0.0001}{\mathbf{0.0008}}$& $\underset{0.0001}{\mathbf{0.0008}}$ & $\underset{-}{\mathbf{-}}$  \\
		\hline
	\end{tabular}
...
\begin{table}[h!]
	...
	\begin{tabular}{l*{6}{c}r}
		...
		MISC ($TOl=10^{-3}$)  &  $\mathbf{0.0190}$ & $\mathbf{0.0094}$& $\mathbf{\red{0.0042}}$ & $\mathbf{ 0.0008}$  \\
		MISC ($TOl=10^{-4}$)  &  $\mathbf{\red{0.0182}}$ & $\mathbf{\red{0.0086}}$& $\mathbf{0.0050}$ & $\mathbf{ -}$  \\
		\hline
		MC  ($M=3.10^6$)   & $\mathbf{0.0180}$  & $\mathbf{ 0.0084}$  & $\mathbf{0.0048}$ & $\mathbf{ 0.0014}$  \\		
		\hline
	\end{tabular}
...
\begin{table}[h!]
	...
	\begin{tabular}{l*{6}{c}r}
		...
		MISC ($TOl=10^{-4}$)  & $\red{1}$ & $\red{6}$ & $140$ & $-$ \\
		\hline
		MC method ($M=3.10^6$)   & $88$  & $96$  & $112$ & $156$  \\	
		\hline
	\end{tabular}
