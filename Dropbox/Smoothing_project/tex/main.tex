...
\begin{table}[h!]
	...
	\begin{tabular}{l*{6}{c}r}
		Method \textbackslash  Steps            & $1-2$ & $2-4$ & $4-8$ & $8-16$ &   \\
		\hline
		MISC ($TOl=5.10^{-1}$) & $\red{0.3}$ & $1$ & $\red{4}$ & $\red{9}$  \\
		MISC ($TOl=10^{-1}$)  & $0.3$& $1$ & $8$ & $42$  \\
		MISC ($TOl=5.10^{-2}$)   & $0.3$ & $1$ & $10$ & $72$  \\
		MISC ($TOl=10^{-2}$)  & $0.3$ & $\red{4}$ & $15$ & $78$  \\
		MISC ($TOl=10^{-3}$)   &$0.3$ & $4$ & $100$ & $2253$  \\
			MISC ($TOl=10^{-4}$)   &$0.3$ & $68$ & $392$ & $$  \\
		\hline
		MC+root finding method     & $\red{-}$ & $\red{60}$ & $\red{77}$ & $\red{152}$  \\
			MC   & $\red{-}$ & $\red{12}$ & $\red{24}$ & $\red{152}$  \\
		\hline
	\end{tabular}
	\caption{Comparsion of the computational time of  MC and MISC, used to compute Binary option price  for different number of time steps, with Richardson extrapolation (level $1$)}
...
\begin{table}[h!]
	...
	\begin{tabular}{l*{6}{c}r}
		Method \textbackslash  Steps            & $1-2$ & $2-4$ & $4-8$ & $8-16$ &   \\
		\hline
		MISC ($TOl=5.10^{-1}$) & $\red{0.3}$ & $\red{4}$ & $\red{56}$ & $\red{713}$  \\
		MISC ($TOl=10^{-1}$)  & $0.3$  & $4$ & $107$ & $1126$  \\
		MISC ($TOl=5.10^{-2}$)   & $0.3$  & $9$ & $135$ & $1253$  \\
		MISC ($TOl=10^{-2}$)  &  $0.3$  & $9$ & $186$ & $3540$  \\
		MISC ($TOl=10^{-3}$)   & $0.3$  & $63$ & $836$ & $$  \\
		\hline
		MC method ($M=10^5$)    & $\red{194}$ & $\red{394}$ & $\red{516}$ & $\red{725}$  \\
		\hline
	\end{tabular}
	\caption{Comparsion of the computational time of  MC and MISC, used to compute Call option price  for different number of time steps, with Richardson extrapolation (level $1$)}
