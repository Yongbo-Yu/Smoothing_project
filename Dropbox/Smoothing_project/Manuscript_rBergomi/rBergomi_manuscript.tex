...
\title{\red{Hierarchical adaptive sparse  grids and Quasi Monte Carlo for option pricing under the rough Bergomi model}} 
...
\input{problem_setting}
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\red{
 \section{Weak error discussion}\label{sec:Weak error analysis}

\input{Weak_error_analysis.tex}
}
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 
\section{\red{Details of our hierarchical methods}}\label{sec:Details our approach and error bounds}
