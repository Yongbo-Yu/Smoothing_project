...
\begin{table}[!h]
	...
	\end{tabular}
\end{small}
	\caption{Summary of relative errors and computational gains, achieved by the different methods. In this table, we highlight the computational gains achieved by MISC over MC method to meet a certain error tolerance. These gains are improved when applying Richardson extrapolation as observed for the case of parameters set $1$. We provide details about the way we compute these gains for each case, in the following sections.}
...
\FloatBarrier
	...
	\caption{Computational work comparison for  MISC  and MC methods. This plot shows that to achieve a relative error below $1\%$, MISC outperforms MC method in terms of computational time.}
...
\FloatBarrier
	...
	\caption{Comparison of computational work for MC and MISC methods. This plot shows that to achieve a relative error below $1\%$, MISC outperforms MC method in terms of computational time.}
...
\FloatBarrier
	...
	\caption{Comparison of computational work for MC and MISC methods. This plot shows that to achieve a relative error around $1\%$, MISC and  MC methods have similar performance in terms of computational time.}
