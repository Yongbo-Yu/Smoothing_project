...
\subsubsection{Comparison between the two approaches of simulating the volatility process ($n=1$)}\label{sec:Comparison between the two approaches of simulating the volatlity process}
