...
N=5;              % probability space dimension

%% Settings
sg_struct.func=func;
sg_struct.N=N;
sg_struct.d_ind=d_ind;
sg_struct.scheme=['H','H','H','H','H']; % sparse grid scheme
sg_struct.scheme_detail={[0.0,1],[0.0,0.5],[0.0,0.2],[0.0,0.1],[0.0,0.1]};
