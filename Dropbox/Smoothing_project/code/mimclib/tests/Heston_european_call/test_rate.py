...
def first_difference_rate_plotting():       
    ...
    plt.savefig('./results/first_difference_heston_2steps_non_hierarchical.eps', format='eps', dpi=1000)
...
def mixed_difference_order2_rate_plotting(d):       
    ...
    plt.savefig('./results/mixed_difference_order2_heston_2steps_non_hierarchical.eps', format='eps', dpi=1000)       
