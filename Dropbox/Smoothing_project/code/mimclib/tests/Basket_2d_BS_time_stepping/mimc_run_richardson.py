...
class MyRun:
    ...
    def initRun(self, run):
        ...
        self.extrapolate_s_dims = self.prb.basket_d*(2*self.prb.N-1) #SET TO SAME AS INPUT DIMENSION
    ...
    ##
        ...
        self.misc = misc.MISCSampler(d=0, fnKnots=fnKnots, min_dim=self.prb.basket_d*(2*self.prb.N-1))
