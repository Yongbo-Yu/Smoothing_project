...
# QMC_err=np.array([1.1,   0.595 ,  0.375,0.17, 0.09, 0.035])
# QMC_time=4*np.array([ 0.007, 0.016 , 0.039, 0.11,0.73, 10])
...
# QMC_rich_err=np.array([  1.59,0.14  ,0.033,0.005  ])
# QMC_rich_time=4*np.array([ 0.02, 1.5, 14, 280 ])
...
# QMC_rich_2_time=4*np.array([ 0.5, 120 ])
...
#plt.plot(MC_err_extrapol, fit_MC*0.0001,linewidth=2.0,label=r'slope= %s' % format(z_MC[0]  , '.2f'), linestyle = '--', color = 'b')
...
plt.plot(MISC_err, fit_MISC*0.0001,linewidth=2.0,label=r'slope= %s' % format(z_MISC[0]   , '.2f'), linestyle = '--', color='b')
...
#plt.plot(MC_rich_err_extrapol, fit_MC_rich*0.02,linewidth=1.0,label=r'slope= %s' % format(z_MC_rich[0]  , '.2f'), linestyle = '--', color='b')

plt.plot(MISC_rich_err,MISC_rich_time,linewidth=2.0,label='ASGQ+Rich(level 1)'  , marker='*',hold=True, color='r') 
plt.plot(MISC_rich_err, fit_MISC_rich*0.01,linewidth=2.0,label=r'slope= %s' % format(z_MISC_rich[0]  , '.2f'), linestyle = '--',color='r')
...
plt.plot(MISC_rich_2_err, fit_MISC_rich_2*0.01,linewidth=2.0,label=r'slope= %s' % format(z_MISC_rich_2[0]  , '.2f'), linestyle = '--',color='g')
...
plt.savefig('./results/error_vs_time_set2_MISC_comparison.eps', format='eps', dpi=1000)  
