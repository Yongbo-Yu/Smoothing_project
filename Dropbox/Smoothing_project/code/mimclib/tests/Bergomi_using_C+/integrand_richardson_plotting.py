...
class Problem_measure_change_rich(object):
...
#methods
    ...
    def fun_1D(self,y11):
        ...
        y=np.array([y12,y12,y12,y12,y12,y12,y12,y11])   # 4 steps in finer
        

        #y12=np.zeros_like(y11)
        #y=np.array([y12,y12,y12,y11])  # 2 steps in finer
...
prb=Problem_measure_change_rich()
...
plt.xlabel(r'$W_2^4$',  fontsize=20, fontweight='bold')
plt.ylabel(r'$I(W_2^4)$', fontsize=20, fontweight='bold')

plt.savefig('./results/Bergomi_integrand_rich_level1_K_1_H_007_y8f_N_2.pdf', format='pdf', dpi=600) 
