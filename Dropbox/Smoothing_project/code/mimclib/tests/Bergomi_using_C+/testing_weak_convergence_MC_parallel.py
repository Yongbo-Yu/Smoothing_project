...
def weak_convergence_differences():    
        ...
        plt.savefig('./results/weak_convergence_order_Bergomi_H_007_K_1_M_10_08_CI_relative.eps', format='eps', dpi=1000)  
        ...
        plt.subplots_adjust(wspace=0.6, hspace=0.6, left=0.15, bottom=0.22, right=0.96, top=0.96)
        plt.legend(loc='upper left')
        plt.savefig('./results/weak_convergence_order_differences_Bergomi_H_007_K_08_M_10_4_CI_relative.eps', format='eps', dpi=1000)  
