...
dt_arr=np.array([0.5, 0.1,  0.05, 0.01, 0.001, 0.0005,0.0001])
...
# quad_err_N_4=np.array([0.1048,0.1048, 0.0997, 0.0177,0.0303,0.0303])
...
# quad_err_N_4=np.array([ 0.0248,0.0248,0.0248,0.0168, 0.0032, 0.0048, 0.0048])
# quad_err_N_8=np.array([ 0.0216, 0.0216, 0.0216,  0.0032, 0.0016,	0.0024,	0.0024])
...
plt.savefig('./results/relative_quad_error_wrt_MISC_TOL_set2_with_rich.eps', format='eps', dpi=1000)  
