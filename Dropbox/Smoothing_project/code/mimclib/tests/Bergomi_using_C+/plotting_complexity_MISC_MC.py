...
# MC_err=np.array([    1.05, 0.59, 0.31,0.14,0.08 ])
# MC_time=np.array([ 0.001, 0.003, 0.02,0.2,1])
...
# fit_MC_rich_2=np.exp(z_MC_rich_2[0]*np.log(MC_rich_2_err))
# print z_MC_rich_2[0]
...
plt.plot(MC_err, fit_MC*0.00001,linewidth=2.0,label=r'rate= %s' % format(z_MC[0]  , '.2f'), linestyle = '--')

plt.plot(MISC_err,MISC_time,linewidth=2.0,label='MISC'  , marker='v',hold=True) 
plt.plot(MISC_err, fit_MISC*0.00001,linewidth=2.0,label=r'rate= %s' % format(z_MISC[0]  , '.2f'), linestyle = '--')

# plt.plot(MC_rich_err,MC_rich_time,linewidth=2.0,label='MC+Rich(level 1)' , marker='>',hold=True) 
# plt.plot(MC_rich_err, fit_MC_rich*0.1,linewidth=2.0,label=r'rate= %s' % format(z_MC_rich[0]  , '.2f'), linestyle = '--')

# plt.plot(MISC_rich_err,MISC_rich_time,linewidth=2.0,label='MISC+Rich(level 1)'  , marker='v',hold=True) 
# plt.plot(MISC_rich_err, fit_MISC_rich,linewidth=2.0,label=r'rate= %s' % format(z_MISC_rich[0]  , '.2f'), linestyle = '--')

# plt.plot(MC_rich_2_err,MC_rich_2_time,linewidth=2.0,label='MC+Rich(level 2)' , marker='>',hold=True) 
# plt.plot(MC_rich_2_err, fit_MC_rich_2,linewidth=2.0,label=r'rate= %s' % format(z_MC_rich_2[0]  , '.2f'), linestyle = '--')

# plt.plot(MISC_rich_2_err,MISC_rich_2_time,linewidth=2.0,label='MISC+Rich(level 2)'  , marker='v',hold=True) 
# plt.plot(MISC_rich_2_err, fit_MISC_rich_2,linewidth=2.0,label=r'rate= %s' % format(z_MISC_rich_2[0]  , '.2f'), linestyle = '--')
