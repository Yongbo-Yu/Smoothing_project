...
parser.add_argument("-db_tag", type=str, action="store",
                    default="1DBS_8_16steps_smooth_payoff2_richardson", help="Database tag")
...
if not args.db:
    ...
    cmd_multi = "python " + base + " -mimc_verbose 0 -db True -db_tag 1DBS_8_16steps_smooth_payoff2_richardson"
