...
class MyRun:
    ...
    def initRun(self, run):
        self.prev_val = 0
        self.prb = Problem_non_smooth_richardson_extrapolation(run.params,1) 
...
if __name__ == "__main__":
    from Problem_non_smooth_richardson_extrapolation import Problem_non_smooth_richardson_extrapolation

    Problem_non_smooth_richardson_extrapolation.Init()
    import mimclib.test
    run = MyRun()
    ...
    Problem_non_smooth_richardson_extrapolation.Final()