...
# attributes
    ...
    N=7 # number of time steps which will be equal to the number of brownian bridge components (we set is a power of 2)
...
#methods
    ...
    def objfun(self,y):
        ...
        points_left=cartesian(mylist_left)
        ...
        points_right=cartesian(mylist_right)
...
def first_difference_rate_plotting():       
    ...
    plt.savefig('./results/first_difference_1D_BS_8steps.eps', format='eps', dpi=1000)
...
def mixed_difference_order2_rate_plotting(d):       
    ...
    for k in range(0,3):  
        ...
        plt.ylabel(r'$\mid \Delta E_{\mathbf{1}+k \bar{\beta}} \mid $',fontsize=14)  
    plt.legend(loc='upper right')
    plt.savefig('./results/mixed_difference_order2_1D_BS_8steps.eps', format='eps', dpi=1000)       
