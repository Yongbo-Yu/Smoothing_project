...
class MyRun:
    ...
    def initRun(self, run):
        self.prev_val = 0
        self.prb = Problem_non_smooth_richardson_extrapolation_call(run.params,1) 
...
if __name__ == "__main__":
    from Problem_non_smooth_richardson_extrapolation_call import Problem_non_smooth_richardson_extrapolation_call

    Problem_non_smooth_richardson_extrapolation_call.Init()
    import mimclib.test
    run = MyRun()
    ...
    Problem_non_smooth_richardson_extrapolation_call.Final()