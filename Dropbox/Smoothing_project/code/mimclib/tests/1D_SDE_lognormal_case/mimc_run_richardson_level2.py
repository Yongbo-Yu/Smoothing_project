...
class MyRun:
    ...
    def initRun(self, run):
        self.prev_val = 0
        self.prb = Problem_richardson_level2_call(run.params,1) 
        #self.extrapolate_s_dims = self.prb.N -1
        self.extrapolate_s_dims = 4*self.prb.N-1 #SET TO SAME AS INPUT DIMENSION
    ...
    ##
        ...
        self.misc = misc.MISCSampler(d=0, fnKnots=fnKnots, min_dim=4*self.prb.N-1)
...
if __name__ == "__main__":
    from Problem_richardson_level2_call import Problem_richardson_level2_call

    Problem_richardson_level2_call.Init()
    import mimclib.test
    run = MyRun()
    ...
    Problem_richardson_level2_call.Final()