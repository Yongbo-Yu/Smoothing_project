...
plt.plot(MC_err_extrapol, fit_MC*0.00001,linewidth=1.0,label=r'slope= %s' % format(-3.0 , '.2f'), linestyle = '--', color = 'b')

plt.plot(MISC_err,MISC_time,linewidth=2.0,label='ASGQ'  , marker='v',hold=True,color='r') 
plt.plot(MISC_err, fit_MISC*0.0001,linewidth=2.0,label=r'slope= %s' % format(-2.0   , '.2f'), linestyle = '--', color='r')
...
# plt.plot(MISC_rich_err,MISC_rich_time,linewidth=2.0,label='ASGQ+Rich(level 1)'  , marker='v',hold=True, color='aquamarine') 
...
# plt.plot(MISC_rich_2_err,MISC_rich_2_time,linewidth=2.0,label='ASGQ+Rich(level 2)'  , marker='v',hold=True,color='brown' ) 
