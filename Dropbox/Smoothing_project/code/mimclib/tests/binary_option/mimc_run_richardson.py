...
class MyRun:
    ...
    def initRun(self, run):
        self.prev_val = 0
        self.prb = Problem_non_smooth_richardson_extrapolation_binary(run.params,1) 
...
if __name__ == "__main__":
    from Problem_non_smooth_richardson_extrapolation_binary import Problem_non_smooth_richardson_extrapolation_binary

    Problem_non_smooth_richardson_extrapolation_binary.Init()
    import mimclib.test
    run = MyRun()
    ...
    Problem_non_smooth_richardson_extrapolation_binary.Final()