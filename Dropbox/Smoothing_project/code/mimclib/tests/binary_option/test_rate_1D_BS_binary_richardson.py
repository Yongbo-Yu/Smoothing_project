...
def first_difference_rate_plotting():       
    ...
    plt.savefig('./results/first_difference_1D_BS_richardson_8_16_no_middle.eps', format='eps', dpi=1000)
...
def mixed_difference_order2_rate_plotting(d):       
    ...
    plt.savefig('./results/mixed_difference_order2_BS_richardson_8_16_no_middle.eps', format='eps', dpi=1000)       
