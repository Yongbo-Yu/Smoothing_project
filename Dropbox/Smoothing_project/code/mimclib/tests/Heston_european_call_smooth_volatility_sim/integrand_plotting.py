...
# attributes
    ...
    exact=4.871489 #  S_0=K=100, T=1, r=0,rho=-0.9, v_0=0.04, theta=0.0125, xi=0.5,\kapp=5
    yknots_right=[]
    yknots_left=[]
...
#methods
    ...
    def fun_1D(self,y11):
        ...
        y=np.array([y12,y11,y12])  # 2 steps
...
plt.xlabel(r'$y_2$',  fontsize=20, fontweight='bold')
plt.ylabel(r'$I(y_2)$', fontsize=20, fontweight='bold')

plt.savefig('./results/heston_2steps_hierarchical_y2.pdf', format='pdf', dpi=600) 
