...
class Problem_general_n_int(object):
...
#methods
    ...
    def __init__(self,coeff,params,nested=False):
        ...
        # self.lower_triang_cholesky = np.linalg.cholesky(self.Rho)
        self.kappa= 1.0
    ...
    def objfun(self,nelem,y):
        ...
        y2=y[self.N:2*self.N] # this points are related to the volatility path
        ...
        bar_z=self.newtons_method(y6[0],y6s,y2[0],y2[1:self.N],y1[0],y1[1:self.N])
        ...
        x_l=np.asarray([self.stock_price_trajectory_1D_heston(bar_z-points_left[i,0],points_left[i,1:],y2[0],y2[1:self.N], y1[0],y1[1:self.N])[0]  for i in range(0,len(self.yknots_left[0]))])       
        ...
        x_r=np.asarray([self.stock_price_trajectory_1D_heston(points_right[i,0]+bar_z,points_right[i,1:],y2[0],y2[1:self.N], y1[0],y1[1:self.N])[0] for i in range(0,len(self.yknots_right[0]))])
    ...
    #def stock_price_trajectory_1D_heston(self,y1,y,yv5,yv_5,yv4,yv_4,yv3,yv_3,yv2,yv_2,yv1,yv_1):
    def stock_price_trajectory_1D_heston(self,y1,y,yv2,yv_2,yv1,yv_1):
        bb=self.brownian_increments(y1,y)
        dW= [bb[0,i+1]-bb[0,i] for i in range(0,self.N)] 
    
        #  hierarhcical
        bb_v1=self.brownian_increments(yv1,yv_1)
        dW_v1= [bb_v1[0,i+1]-bb_v1[0,i] for i in range(0,self.N)] 

        bb_v2=self.brownian_increments(yv2,yv_2)
        dW_v2= [bb_v2[0,i+1]-bb_v2[0,i] for i in range(0,self.N)]
        ...
        X_v1=np.zeros(self.N+1) #here will store the  Bessel process trajectory
        X_v2=np.zeros(self.N+1) #here will store the  Bessel process trajectory
        ...
        dW_tilde=np.zeros(self.N) #here will store the  Bessel process trajectory
        ...
        y_tilde=(1/np.sqrt(V[self.N-1]))*(yv1*X_v1[self.N-1]+yv2*X_v2[self.N-1])
    ...
    #def dx(self,x,y,yv5,yv_5,yv4,yv_4,yv3,yv_3,yv2,yv_2,yv1,yv_1):
    def dx(self,x,y,yv2,yv_2,yv1,yv_1):
        #P1,dP1=self.f(x,y,yv5,yv_5,yv4,yv_4,yv3,yv_3,yv2,yv_2,yv1,yv_1)
        P1,dP1=self.f(x,y,yv2,yv_2,yv1,yv_1)
        return abs(0-P1)

  
    #def f(self,y1,y,yv5,yv_5,yv4,yv_4,yv3,yv_3,yv2,yv_2,yv1,yv_1):
    def f(self,y1,y,yv2,yv_2,yv1,yv_1):
        #X,dbb,V,y1s=self.stock_price_trajectory_1D_heston(y1,y,yv5,yv_5,yv4,yv_4,yv3,yv_3,yv2,yv_2,yv1,yv_1) # right version
        X,dbb,V,y1s=self.stock_price_trajectory_1D_heston(y1,y,yv2,yv_2,yv1,yv_1) # right version
    ...
    #def newtons_method(self,x0,y,yv5,yv_5,yv4,yv_4,yv3,yv_3,yv2,yv_2,yv1,yv_1,eps=1e-10):
    def newtons_method(self,x0,y,yv2,yv_2,yv1,yv_1,eps=1e-10):
        #delta = self.dx(x0,y,yv5,yv_5,yv4,yv_4,yv3,yv_3,yv2,yv_2,yv1,yv_1)
        delta = self.dx(x0,y,yv2,yv_2,yv1,yv_1)
        while delta > eps:
    
            #P_value,dP=self.f(x0,y,yv5,yv_5,yv4,yv_4,yv3,yv_3,yv2,yv_2,yv1,yv_1)
            P_value,dP=self.f(x0,y,yv2,yv_2,yv1,yv_1)
