...
parser.add_argument("-db_tag", type=str, action="store",
                    default="1DBS_4steps_non_smooth_testing", help="Database tag")
...
#case of 1 D problem
if dim == 0:
  base = "mimc_run_general_n.py -mimc_TOL {TOL} -mimc_min_dim {the_dim} -qoi_dim {the_dim} -ksp_rtol 1e-25 -ksp_type gmres -mimc_M0 1 \
...
if not args.db:
    ...
    cmd_multi = "python " + base + " -mimc_verbose 0 -db True -db_tag 1DBS_4steps_non_smooth_testing"
