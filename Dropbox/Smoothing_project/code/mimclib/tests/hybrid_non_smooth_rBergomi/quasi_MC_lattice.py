...
# attributes
   ...
   # y1perp = Vector(N)
    ...
    def __init__(self,Nsteps,nested=False):
        ...
        self.shifts = np.random.rand(self.M, 3*Nsteps)
    ...
    def objfun(self,x,Nsteps):
        ...
        W1=y[0:Nsteps]
        W2=y[Nsteps:2*Nsteps]
        W3=y[2*Nsteps:3*Nsteps]
        QoI=self.z.ComputePayoffRT_single(W1,W2,W3)
        return QoI
...
def weak_convergence_differences():    
       ...
       #exact=0.2407117  #exact value of K=0.8, H=0.02_xi_01_eta_0_4_r__07
        ...
        for i in range(0,1):
            ...
            latgen = latticeseq_b2('exod2_base2_m20_CKN.txt', s=3*Nsteps_arr[i])
            n = N/prb.M
            print n
