...
parser.add_argument("-db_tag", type=str, action="store",
                    default="test_001", help="Database tag")
...
if not args.db:
    cmd_single = "python " + base + " -mimc_verbose 10 -db True -db_tag test_001 " #verbose >0 detailed printing results
    ...
    for i in range(0, args.tries):
       print cmd_multi.format(tag=args.db_tag.format(dim),TOL=0.01)
