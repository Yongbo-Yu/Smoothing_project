...
class SQLiteDBConn(object):
    ...
    def __enter__(self):
        import sqlite3
        #added by chiheb (timeout to prevent locking of data base)
        self.conn = sqlite3.connect( timeout=100, **self.connArgs)
    ...
    def execute(self, query, params=[]):
        ...
        for q in query.split(';'):
            #this added by me
            #self.cur.execute("PRAGMA busy_timeout = 30000")   # 30 s
